                    ...
                    <form action="" className='mx-auto w-full max-w-md col-span-12 lg:col-span-5 lg:mx-0'
                        ...
                        <div className='flex gap-x-3'>
                            ...
                            <input id="email-address"
                                ...
                                autoComplete="email"
                                required
                                className="min-w-0 flex-auto rounded-xl border-0 bg-white/5 px-3.5 py-2 text-black shadow-sm ring-1 ring-inset ring-black/40 focus:ring-inset sm:text-sm sm:leading-6" placeholder="Enter your email" />
